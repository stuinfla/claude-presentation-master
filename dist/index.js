...
__export(index_exports, {
  ...
  HTMLLayoutValidator: () => HTMLLayoutValidator,
  HallucinationDetector: () => HallucinationDetector,
  KnowledgeBase: () => KnowledgeBase,
  LocalImageProvider: () => LocalImageProvider,
  MermaidProvider: () => MermaidProvider,
  PPTXValidator: () => PPTXValidator,
  PRESENTATION_TYPE_RULES: () => PRESENTATION_TYPE_RULES,
...
\u{1F7E1} MODERATE (${bySeverity.moderate.length}):`);
  ...
  async initBrowser() {
    if (!this.browser) {
      this.browser = await import_playwright2.chromium.launch({ headless: true });
    }
  }
  async closeBrowser() {
    if (this.browser) {
